<x-layout>
    ...
    <section>
        <div class="flex justify-end mt-5">
            <div class="flex justify-between">
                ...
                @can('update', $post)
                    <a href="{{ route('posts.edit', $post->id) }}" class="text-white focus:ring-4 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-blue-800">
                        Edit
                    </a>
    ...
    <main class="max-w-6xl mx-auto mt-6 lg:mt-20 space-y-6 align-items: center">
        ...
        <a href="#" class="inline-flex items-center text-lg text-blue-500 hover:underline">
            Read more
