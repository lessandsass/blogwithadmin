        ...
        <form method="POST" action="{{ route('register.store') }}">
            ...
            <div class="mb-6">
                ...
                <input
                    type="text"
                    name="name"
                    class="block w-full p-3 bg-gray-900 border border-gray-800 placeholder-gray-500 text-gray-300 rounded-lg focus:outline-none @error('name') border-red-500 @enderror"
            ...
            <div class="mb-6">
                <label for="password_confirmation" class="block mb-2 text-sm font-medium text-gray-200">Password Confirmation</label>
                <input
                    type="password"
